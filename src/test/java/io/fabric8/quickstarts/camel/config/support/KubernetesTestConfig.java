package io.fabric8.quickstarts.camel.config.support;
...
import static io.fabric8.quickstarts.camel.config.support.KubernetesTestUtil.failNotDeployed;
import static io.fabric8.quickstarts.camel.config.support.KubernetesTestUtil.getArrayListStringProperty;
import static io.fabric8.quickstarts.camel.config.support.KubernetesTestUtil.getArtifactId;
import static io.fabric8.quickstarts.camel.config.support.KubernetesTestUtil.getBooleanProperty;
import static io.fabric8.quickstarts.camel.config.support.KubernetesTestUtil.getIntProperty;
import static io.fabric8.quickstarts.camel.config.support.KubernetesTestUtil.getResourceFileAsStream;
import static io.fabric8.quickstarts.camel.config.support.KubernetesTestUtil.getStringProperty;
import static io.fabric8.quickstarts.camel.config.support.KubernetesTestUtil.isNullOrEmpty;
